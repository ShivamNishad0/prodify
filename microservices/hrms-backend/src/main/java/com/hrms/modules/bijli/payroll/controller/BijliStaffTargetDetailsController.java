...
import com.hrms.modules.bijli.payroll.serviceImpl.BijliStaffTargetDetailsServiceImpl;
...
@RestController
@CrossOrigin
@RequestMapping("/api/spshrm/bijli/targets")
public class BijliStaffTargetDetailsController {
    @Autowired
    private BijliStaffTargetDetailsServiceImpl staffTargetDetailsService;
    ...
    public ResponseEntity<?> getStaffDetails(
        ...
        TargetResponseDTO data=staffTargetDetailsService.staffDetails( month, year, areaId, page, size);
