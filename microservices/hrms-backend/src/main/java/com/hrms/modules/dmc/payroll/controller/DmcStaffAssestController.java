...
@RestController
@CrossOrigin
@RequestMapping("/api/spshrm/dmc/assets")
public class DmcStaffAssestController {
	@Autowired
	private DmcStaffAssestService assetService;

	@PostMapping("/new-asset")
	public ResponseEntity<String> createNewAsset(@RequestBody DmcAssest asset) {
	...
	@PutMapping("/{assetId}")
	public ResponseEntity<String> updateAsset(@PathVariable Long assetId, @RequestBody DmcAssest asset) {
	...
	@GetMapping("/{assetId}")
	public ResponseEntity<DmcAssest> getByAssetId(@PathVariable Long assetId) {
		DmcAssest foundAsset = assetService.getByassetId(assetId);
		if (foundAsset != null) {
	...
	public ResponseEntity<List<DmcAssest>> getAllAssets() {
		List<DmcAssest> foundAssets = assetService.getAllAsset();
