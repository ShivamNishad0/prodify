...
import com.hrms.modules.dmc.payroll.serviceImpl.DmcStaffSalaryDetailsServiceImpl;
...
@Service
public class DmcSalaryStructureServiceImpl implements DmcSalaryStructureService {

	@Autowired
	private DmcSalaryStructureRepo salaryRepo;
	@Autowired
	private DmcStaffSalaryDetailsServiceImpl detailsService;
	
	@Override
	public String newSalaryStructure(DmcSalaryStructure salary) {
		DmcSalaryStructure found = salaryRepo.findByStaffId(salary.getStaffId());
		if(found==null) {
			DmcSalaryStructure saved = salaryRepo.save(salary);
			if(saved!=null) {
	...
	public String updateSalary(Long salaryId, DmcSalaryStructure salary) {
		DmcSalaryStructure found = salaryRepo.findById(salaryId).get();
		...
		DmcSalaryStructure saved = salaryRepo.save(found);
	...
	public DmcSalaryStructure findByStaffId(Long staffId) {
		DmcSalaryStructure found= salaryRepo.findByStaffId(staffId);
