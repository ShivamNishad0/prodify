...
import com.hrms.modules.bhilai.payroll.serviceImpl.BhilaiManualAttendanceService;
...
@RestController
@CrossOrigin
@RequestMapping("/api/spshrm/bhilai/attendance")
public class BhilaiStaffAttendanceController {
	@Autowired
	private BhilaiStaffAttendanceService attendanceService;

	@Autowired
	private BhilaiAttendanceDeatilsService attendaceDetails;

	@Autowired
	private BhilaiManualAttendanceService manualAttendanceService;
	...
	public ResponseEntity<BhilaiStaffAttendance> getAttendanceByEmpNo(@PathVariable String empNo, @RequestParam String month, @RequestParam int year) {
		BhilaiStaffAttendance attendance = attendanceService.findByempNo(empNo,month,year);
		if (attendance != null) {
	...
	public ResponseEntity<?> getAttendanceDetailsByEmpNo(@PathVariable String empNo,@PathVariable String year) {
		List<BhilaiAttendanceDeatils> details = attendaceDetails.findAttendanceDetailsByEnpNo(empNo,year);
		if (details != null) {
