...
@RestController
@CrossOrigin
@RequestMapping("/api/spshrm/bhilai/assets")
public class BhilaiStaffAssestController {
	@Autowired
	private BhilaiStaffAssestService assetService;

	@PostMapping("/new-asset")
	public ResponseEntity<String> createNewAsset(@RequestBody BhilaiAssest asset) {
	...
	@PutMapping("/{assetId}")
	public ResponseEntity<String> updateAsset(@PathVariable Long assetId, @RequestBody BhilaiAssest asset) {
	...
	@GetMapping("/{assetId}")
	public ResponseEntity<BhilaiAssest> getByAssetId(@PathVariable Long assetId) {
		BhilaiAssest foundAsset = assetService.getByassetId(assetId);
		if (foundAsset != null) {
	...
	public ResponseEntity<List<BhilaiAssest>> getAllAssets() {
		List<BhilaiAssest> foundAssets = assetService.getAllAsset();
