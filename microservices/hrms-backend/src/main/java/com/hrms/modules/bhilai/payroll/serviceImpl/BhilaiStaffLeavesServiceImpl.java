...
import com.hrms.modules.bhilai.payroll.repository.BhilaiStaffLeavesRepository;
import com.hrms.modules.bhilai.payroll.service.BhilaiStaffLeavesService;
...
@Service
public class BhilaiStaffLeavesServiceImpl implements BhilaiStaffLeavesService {
	...
	@Override
	 public String createLeave(BhilaiStaffLeaves leave) {
	        ...
	        BhilaiStaffLeaves saveLeaves= leaveRepo.save(leave);
	...
	@Override
	 public String actionOnLeave(String action, Long leaveId, Long userId) {
	        Optional<BhilaiStaffLeaves> optionalLeave = leaveRepo.findById(leaveId);
	        if (!optionalLeave.isPresent()) {
	            return Result.WENT_WRONG.toString();
	        }

	        BhilaiStaffLeaves leave = optionalLeave.get();
	        ...
	        BhilaiStaffLeaves savedLeave = leaveRepo.save(leave);
	...
	public List<BhilaiStaffLeaves> staffLeaves(Long StaffId){
		List<BhilaiStaffLeaves> leaves = leaveRepo.findLeaveByStaffId(StaffId);
