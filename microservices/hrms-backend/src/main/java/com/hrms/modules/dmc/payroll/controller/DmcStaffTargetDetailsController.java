...
import com.hrms.modules.dmc.payroll.serviceImpl.DmcStaffTargetDetailsServiceImpl;
...
@RestController
@CrossOrigin
@RequestMapping("/api/spshrm/dmc/targets")
public class DmcStaffTargetDetailsController {
    @Autowired
    private DmcStaffTargetDetailsServiceImpl staffTargetDetailsService;
