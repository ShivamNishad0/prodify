...
import com.hrms.modules.bijli.payroll.repository.BijliStaffLeavesRepository;
...
@Service
public class BijliStaffLeavesServiceImpl implements BijliStaffLeavesService {
	...
	@Override
	 public String createLeave(BijliStaffLeaves leave) {
	        ...
	        BijliStaffLeaves saveLeaves= leaveRepo.save(leave);
	...
	@Override
	 public String actionOnLeave(String action, Long leaveId, Long userId) {
	        Optional<BijliStaffLeaves> optionalLeave = leaveRepo.findById(leaveId);
	        if (!optionalLeave.isPresent()) {
	            return Result.WENT_WRONG.toString();
	        }

	        BijliStaffLeaves leave = optionalLeave.get();
	        ...
	        BijliStaffLeaves savedLeave = leaveRepo.save(leave);
	...
	public List<BijliStaffLeaves> staffLeaves(Long StaffId){
		List<BijliStaffLeaves> leaves = leaveRepo.findLeaveByStaffId(StaffId);
