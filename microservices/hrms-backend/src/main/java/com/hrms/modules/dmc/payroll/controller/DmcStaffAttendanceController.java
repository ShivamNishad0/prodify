...
import com.hrms.modules.dmc.payroll.serviceImpl.DmcManualAttendanceService;
...
@RestController
@CrossOrigin
@RequestMapping("/api/spshrm/dmc/attendance")
public class DmcStaffAttendanceController {
	@Autowired
	private DmcStaffAttendanceService attendanceService;

	@Autowired
	private DmcAttendanceDeatilsService attendaceDetails;
	@Autowired
	private DmcManualAttendanceService manualAttendanceService;
	...
	public ResponseEntity<DmcStaffAttendance> getAttendanceByEmpNo(@PathVariable String empNo, @RequestParam String month, @RequestParam int year) {
		DmcStaffAttendance attendance = attendanceService.findByempNo(empNo,month,year);
		if (attendance != null) {
	...
	public ResponseEntity<?> getAttendanceDetailsByEmpNo(@PathVariable String empNo,@PathVariable String year) {
		List<DmcAttendanceDeatils> details = attendaceDetails.findAttendanceDetailsByEnpNo(empNo,year);
		if (details != null) {
