...
@RestController
@CrossOrigin
@RequestMapping("/api/spshrm/bhilai/leave")
public class BhilaiStaffLeavesController {

	@Autowired
	private BhilaiStaffLeavesService leaveService;

	@PostMapping("/apply")
	public ResponseEntity<String> createLeave(@RequestBody BhilaiStaffLeaves leave) {
	...
	public ResponseEntity<List<BhilaiStaffLeaves>> getStaffLeaves(@PathVariable Long staffId) {
		List<BhilaiStaffLeaves> leaves = leaveService.staffLeaves(staffId);
