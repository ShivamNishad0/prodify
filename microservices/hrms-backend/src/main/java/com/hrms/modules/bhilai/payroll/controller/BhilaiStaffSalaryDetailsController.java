...
@RestController
@CrossOrigin
@RequestMapping("/api/spshrm/bhilai/payroll")
public class BhilaiStaffSalaryDetailsController {
	@Autowired
	private BhilaiStaffSalaryDetailsService salaryService;
	...
	@GetMapping("/details")
	public ResponseEntity<BhilaiStaffSalaryDetails> findSalaryDetails(@RequestParam Long staffId, @RequestParam String month,
																	  @RequestParam String year) {
		BhilaiStaffSalaryDetails foundSalary = salaryService.findSalaryDetails(staffId, month, year);
		if (foundSalary != null) {
	...
	public ResponseEntity<?> getStaffPrevDetails(
		...
		BhilaiStaffSalaryDetails details = salaryService.findPrevAmt(emp_no, month, year);
		return ResponseEntity.ok(details);
	}
	...
	public  ResponseEntity<?> getAnnualSalary(@RequestParam("empNo")String empNo,
											  @RequestParam("zoneId")Long zoneId,
											  @RequestParam("year")String year){
		List<BhilaiStaffSalaryDetails> result = salaryService.getAnualResultOfEmp(empNo,zoneId,year);
