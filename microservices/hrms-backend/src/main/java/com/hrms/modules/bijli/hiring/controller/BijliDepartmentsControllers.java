...
@RestController
@RequestMapping("/api/spshrm/bijli/department")
@CrossOrigin
public class BijliDepartmentsControllers {

	 @Autowired
	    private BijliDepartmentsServices depService;

	    @PostMapping("/create")
	    public ResponseEntity<String> createDepartment(@RequestBody BijliDepartments dep) {
	    ...
	    @PutMapping("/edit/{id}")
	    public ResponseEntity<String> editDepartment(@PathVariable Long id, @RequestBody BijliDepartments dep) {
	    ...
	    @GetMapping("/find/{id}")
	    public ResponseEntity<BijliDepartments> findById(@PathVariable Long id) {
	        BijliDepartments dep = depService.findById(id);
	        if (dep != null) {
	    ...
	    @GetMapping("/all")
	    public ResponseEntity<List<BijliDepartments>> allDepartment() {
	        List<BijliDepartments> deps = depService.allDepartment();
