...
@RestController
@CrossOrigin
@RequestMapping("/api/spshrm/bijli/designations")
public class BijliDesignationsController {
	 @Autowired
	    private BijliDesignationsServices desigService;

	    @PostMapping("/create")
	    public ResponseEntity<String> createDesignation(@RequestBody BijliDesignations desig) {
	    ...
	    @PutMapping("/edit/{id}")
	    public ResponseEntity<String> editDesignation(@PathVariable Long id, @RequestBody BijliDesignations desig) {
	    ...
	    @GetMapping("/find/{id}")
	    public ResponseEntity<BijliDesignations> findById(@PathVariable Long id) {
	        BijliDesignations desig = desigService.findById(id);
	        if (desig != null) {
	    ...
	    @GetMapping("/all")
	    public ResponseEntity<List<BijliDesignations>> getAllDesignation() {
	        List<BijliDesignations> desigs = desigService.getAllDesignation();
