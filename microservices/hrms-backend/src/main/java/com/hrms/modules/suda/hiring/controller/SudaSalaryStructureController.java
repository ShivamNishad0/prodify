...
@RestController
@CrossOrigin
@RequestMapping("/api/spshrm/suda/salary")
public class SudaSalaryStructureController {

	  @Autowired
	    private SudaSalaryStructureService salaryService;
	  
	  @PostMapping("/new")
	    public ResponseEntity<String> newSalaryStructure(@RequestBody SudaSalaryStructure salary) {
	    ...
	    public ResponseEntity<String> updateSalary(@PathVariable Long salaryId, @RequestBody SudaSalaryStructure salary) {
	        String result = salaryService.updateSalary(salaryId, salary);
	        return ResponseEntity.ok(result);
	    }

	    @GetMapping("/by-staff/{salaryId}")
	    public ResponseEntity<SudaSalaryStructure> findByStaffId(@PathVariable Long salaryId) {
	        SudaSalaryStructure salary = salaryService.findByStaffId(salaryId);
	        return ResponseEntity.ok(salary);
	    }
	    
	    @GetMapping("/by-staff-data/{staffId}")
	    public ResponseEntity<SudaSalaryStructure> findBySatffId(@PathVariable Long staffId) {
	        SudaSalaryStructure salary = salaryService.findByStaffId(staffId);
	        if(salary!=null) {	        	
	        	return ResponseEntity.ok(salary);
	        }
	    ...
	    @GetMapping("/all")
	    public ResponseEntity<List<SudaSalaryStructure>> getAllSalary() {
	        List<SudaSalaryStructure> salaries = salaryService.getAllSalary();
