...
@RestController
@RequestMapping("/api/spshrm/suda/staff")
@CrossOrigin
public class SudaStaffController {

	@Autowired
	private SudaStaffServices staffService;
...
//	}
	...
	public ResponseEntity<?> getdeactivatedStaffByEmpNo(@RequestParam String empNo) {
		SudaRemovedStaffs details = staffService.deactivationDetails(empNo);
		if (details==null) {
			return new ResponseEntity<>(HttpStatus.NO_CONTENT);
		}
